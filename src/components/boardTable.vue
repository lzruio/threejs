 ...
 * @LastEditTime: 2025-03-21 08:54:19
...
<template>
  <div>
    <a-card size="small">
      ...
      <a-table ref="boardTable" :columns="columns" :data-source="boards" size="small" :scroll="{ y: 200 }"
...
const { customRowClassName, handleRowClick, columns, boardTable } = useBoardTable()

const { boards } = storeToRefs(sceneStore)
